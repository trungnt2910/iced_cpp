...
namespace Iced::Intel
{
	...
	class ISymbolResolver
	{
		...
		/// <returns></returns>
	public:
		virtual bool TryGetSymbol(const Instruction& instruction, std::int32_t operand, std::int32_t instructionOperand, std::uint64_t address, std::int32_t addressSize, SymbolResult& symbol) = 0;
	};
