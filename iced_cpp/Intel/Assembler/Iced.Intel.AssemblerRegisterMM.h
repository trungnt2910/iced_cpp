...
namespace Iced::Intel
{
   ...
   //ORIGINAL LINE: [DebuggerDisplay("{" + nameof(Value) + "}")][EditorBrowsable(EditorBrowsableState.Never)] public partial struct AssemblerRegisterMM: IEquatable<AssemblerRegisterMM>
	class AssemblerRegisterMM : public IEquatable<AssemblerRegisterMM>
	{
		/// <summary>
	...
	public:
		AssemblerRegisterMM(Register value);
		/// <summary>
		/// The register value.
		/// </summary>
