...
namespace Iced::Intel
{
   ...
   //ORIGINAL LINE: [DebuggerDisplay("{" + nameof(Value) + "}")][EditorBrowsable(EditorBrowsableState.Never)] public partial struct AssemblerRegisterTR: IEquatable<AssemblerRegisterTR>
	class AssemblerRegisterTR : public IEquatable<AssemblerRegisterTR>
	{
		/// <summary>
	...
	public:
		AssemblerRegisterTR(Register value);
		/// <summary>
		/// The register value.
		/// </summary>
