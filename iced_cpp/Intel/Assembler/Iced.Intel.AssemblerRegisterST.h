...
namespace Iced::Intel
{
   ...
   //ORIGINAL LINE: [DebuggerDisplay("{" + nameof(Value) + "}")][EditorBrowsable(EditorBrowsableState.Never)] public partial struct AssemblerRegisterST: IEquatable<AssemblerRegisterST>
	class AssemblerRegisterST : public IEquatable<AssemblerRegisterST>
	{
		/// <summary>
	...
	public:
		AssemblerRegisterST(Register value);
		/// <summary>
		/// The register value.
		/// </summary>
		...
		operator Register();
		/// <inheritdoc />
		bool Equals(AssemblerRegisterST other) override;
		/// <inheritdoc />
	  ...
	  //ORIGINAL LINE: public override bool Equals(Object? obj)
		...
		/// <returns></returns>
		bool operator == (AssemblerRegisterST right);
		/// <summary>
