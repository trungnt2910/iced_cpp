...
namespace Iced::Intel
{
   ...
   //ORIGINAL LINE: [DebuggerDisplay("{" + nameof(Value) + "}")][EditorBrowsable(EditorBrowsableState.Never)] public partial struct AssemblerRegisterDR: IEquatable<AssemblerRegisterDR>
	class AssemblerRegisterDR : public IEquatable<AssemblerRegisterDR>
	{
		/// <summary>
	...
	public:
		AssemblerRegisterDR(Register value);
		/// <summary>
		/// The register value.
		/// </summary>
		...
		/// <inheritdoc />
		bool Equals(AssemblerRegisterDR other) override;
		/// <inheritdoc />
	  ...
	  //ORIGINAL LINE: public override bool Equals(Object? obj)
		...
		/// <returns></returns>
		bool operator == (AssemblerRegisterDR right);
		/// <summary>
