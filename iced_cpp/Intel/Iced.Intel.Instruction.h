...
namespace Iced::Intel::BlockEncoderInternal
{
	...
	class JccInstr;
	class JmpInstr;
	class SimpleBranchInstr;
	class XbeginInstr;
}

namespace Iced::Intel::DecoderInternal
{
	class OpCodeHandler_MemBx;
}
...
namespace Iced::Intel
{
	...
	private:
		...
		friend class ::Iced::Intel::BlockEncoderInternal::Instr;
		friend class ::Iced::Intel::BlockEncoderInternal::JccInstr;
		friend class ::Iced::Intel::BlockEncoderInternal::JmpInstr;
		friend class ::Iced::Intel::BlockEncoderInternal::SimpleBranchInstr;
		friend class ::Iced::Intel::BlockEncoderInternal::XbeginInstr;
		friend class ::Iced::Intel::DecoderInternal::OpCodeHandler_MemBx;
	private:
	...
	public:
		...
		// ⚠️This was generated by GENERATOR!🦹‍♂️
	private:
		enum class InstrFlags1 : std::uint32_t
		{
		...
		ICED_DEFINE_FLAGS_FRIEND(InstrFlags1)
		ICED_DEFINE_COMP_FRIEND(InstrFlags1)
		ICED_DEFINE_ARITH_FRIEND(InstrFlags1)

			// GENERATOR-END: InstrFlags1
			// GENERATOR-BEGIN: MvexInstrFlags
			// ⚠️This was generated by GENERATOR!🦹‍♂️
	private:
		enum class MvexInstrFlags : std::uint32_t
		{
			MvexRegMemConvShift = 0x00000010,
			MvexRegMemConvMask = 0x0000001F,
			EvictionHint = 0x80000000
		};
		ICED_DEFINE_FLAGS_FRIEND(MvexInstrFlags)
		ICED_DEFINE_COMP_FRIEND(MvexInstrFlags)
		ICED_DEFINE_ARITH_FRIEND(MvexInstrFlags)
	...
	public:
	  ...
	  //ORIGINAL LINE: [MethodImpl(MethodImplOptions.AggressiveInlining)] get
		...
		constexpr void SetCode(Iced::Intel::Code value);
	private:
		constexpr void InternalSetCodeNoCheck(Iced::Intel::Code code);
	public:
		/// <summary>
	...
	public:
	 ...
	 //ORIGINAL LINE: [MethodImpl(MethodImplOptions.AggressiveInlining)] get
	  ...
	  //ORIGINAL LINE: [MethodImpl(MethodImplOptions.AggressiveInlining)] get
		...
		/// </summary>
		constexpr Register GetMemoryBase() const;
		constexpr void SetMemoryBase(Register value);
	private:
		constexpr void SetInternalMemoryBase(Register value);
	public:
		/// <summary>
...
namespace Iced::Intel
{
	constexpr Iced::Intel::Code Instruction::GetCode() const
	{
		return static_cast<Iced::Intel::Code>(code);
	}

	constexpr void Instruction::SetCode(Iced::Intel::Code value)
	{
	...
	constexpr void Instruction::InternalSetCodeNoCheck(Iced::Intel::Code code)
	{
		this->code = static_cast<std::uint16_t>(code);
	}

	constexpr Register Instruction::GetMemoryBase() const
	{
		return static_cast<Register>(memBaseReg);
	}

	constexpr void Instruction::SetMemoryBase(Register value)
	{
		memBaseReg = static_cast<std::uint8_t>(value);
	}

	constexpr void Instruction::SetInternalMemoryBase(Register value)
	{
		memBaseReg = static_cast<std::uint8_t>(value);
	}
}