...
namespace Iced::Intel
{
	...
	private:
		...
		DEFINE_FLAGS_FRIEND(InstrFlags1)
			DEFINE_COMP_FRIEND(InstrFlags1)
			DEFINE_ARITH_FRIEND(InstrFlags1)
	...
	private:
		...
		DEFINE_FLAGS_FRIEND(MvexInstrFlags)
			DEFINE_COMP_FRIEND(MvexInstrFlags)
			DEFINE_ARITH_FRIEND(MvexInstrFlags)
