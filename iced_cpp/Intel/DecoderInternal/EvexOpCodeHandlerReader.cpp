...
namespace Iced::Intel::DecoderInternal
{
	...
	std::int32_t EvexOpCodeHandlerReader::ReadHandlers(TableDeserializer& deserializer, std::vector<OpCodeHandler*>& result, std::int32_t resultIndex)
	{
		...
		case EvexOpCodeHandlerKind::Group:
			elem = new OpCodeHandler_Group(deserializer.ReadArrayReference(static_cast<std::uint32_t>(EvexOpCodeHandlerKind::ArrayReference)));
			return 1;
