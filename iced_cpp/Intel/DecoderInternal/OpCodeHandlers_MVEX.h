...
namespace Iced::Intel::DecoderInternal
{
	...
	{
	private:
		const OpCodeHandler* handlerEH0;
		const OpCodeHandler* handlerEH1;
	public:
		constexpr OpCodeHandler_EH(const OpCodeHandler* handlerEH0, const OpCodeHandler* handlerEH1);
	...
	public:
		constexpr OpCodeHandler_MVEX_M(Code code);
		inline void Decode(Decoder& decoder, Instruction& instruction) const override;
	};
	...
	private:
		Code code = static_cast<Code>(0);
	public:
		constexpr OpCodeHandler_MVEX_MV(Code code);
		inline void Decode(Decoder& decoder, Instruction& instruction) const override;
	};
	...
	private:
		Code code = static_cast<Code>(0);
	public:
		constexpr OpCodeHandler_MVEX_VW(Code code);
		inline void Decode(Decoder& decoder, Instruction& instruction) const override;
	};
	...
	private:
		Code code = static_cast<Code>(0);
	public:
		constexpr OpCodeHandler_MVEX_HWIb(Code code);
		inline void Decode(Decoder& decoder, Instruction& instruction) const override;
	};
	...
	private:
		Code code = static_cast<Code>(0);
	public:
		constexpr OpCodeHandler_MVEX_VWIb(Code code);
		inline void Decode(Decoder& decoder, Instruction& instruction) const override;
	};
	...
	private:
		Code code = static_cast<Code>(0);
	public:
		constexpr OpCodeHandler_MVEX_VHW(Code code);
		inline void Decode(Decoder& decoder, Instruction& instruction) const override;
	};
	...
	private:
		Code code = static_cast<Code>(0);
	public:
		constexpr OpCodeHandler_MVEX_VHWIb(Code code);
		inline void Decode(Decoder& decoder, Instruction& instruction) const override;
	};
	...
	private:
		Code code = static_cast<Code>(0);
	public:
		constexpr OpCodeHandler_MVEX_VKW(Code code);
		inline void Decode(Decoder& decoder, Instruction& instruction) const override;
	};
	...
	private:
		Code code = static_cast<Code>(0);
	public:
		constexpr OpCodeHandler_MVEX_KHW(Code code);
		inline void Decode(Decoder& decoder, Instruction& instruction) const override;
	};
	...
	private:
		Code code = static_cast<Code>(0);
	public:
		constexpr OpCodeHandler_MVEX_KHWIb(Code code);
		inline void Decode(Decoder& decoder, Instruction& instruction) const override;
	};
	...
	private:
		Code code = static_cast<Code>(0);
	public:
		constexpr OpCodeHandler_MVEX_VSIB(Code code);
		inline void Decode(Decoder& decoder, Instruction& instruction) const override;
	};
	...
	private:
		Code code = static_cast<Code>(0);
	public:
		constexpr OpCodeHandler_MVEX_VSIB_V(Code code);
		inline void Decode(Decoder& decoder, Instruction& instruction) const override;
	};
	...
	private:
		Code code = static_cast<Code>(0);
	public:
		constexpr OpCodeHandler_MVEX_V_VSIB(Code code);
		inline void Decode(Decoder& decoder, Instruction& instruction) const override;
	};
}
...
namespace Iced::Intel::DecoderInternal
{
	constexpr OpCodeHandler_EH::OpCodeHandler_EH(const OpCodeHandler* handlerEH0, const OpCodeHandler* handlerEH1)
	{
	...
	inline void OpCodeHandler_EH::Decode(Decoder& decoder, Instruction& instruction) const
	{
	...
	constexpr OpCodeHandler_MVEX_M::OpCodeHandler_MVEX_M(Code code)
	{
	...
	inline void OpCodeHandler_MVEX_M::Decode(Decoder& decoder, Instruction& instruction) const
	{
	...
	constexpr OpCodeHandler_MVEX_MV::OpCodeHandler_MVEX_MV(Code code)
	{
		assert(!(MvexInfo(code)).GetIgnoresOpMaskRegister());
		this->code = code;
	}

	inline void OpCodeHandler_MVEX_MV::Decode(Decoder& decoder, Instruction& instruction) const
	{
		auto& state = decoder.state;
		assert(state.GetEncoding() == EncodingKind::MVEX);
		if ((state.vvvv_invalidCheck & decoder.invalidCheckMask) != 0)
	...
	constexpr OpCodeHandler_MVEX_VW::OpCodeHandler_MVEX_VW(Code code)
	{
		assert(!(MvexInfo(code)).GetIgnoresOpMaskRegister());
		assert((MvexInfo(code)).GetCanUseEvictionHint());
		assert(!(MvexInfo(code)).GetIgnoresEvictionHint());
	...
	inline void OpCodeHandler_MVEX_VW::Decode(Decoder& decoder, Instruction& instruction) const
	{
		auto& state = decoder.state;
		assert(state.GetEncoding() == EncodingKind::MVEX);
		if ((state.vvvv_invalidCheck & decoder.invalidCheckMask) != 0)
	...
	constexpr OpCodeHandler_MVEX_HWIb::OpCodeHandler_MVEX_HWIb(Code code)
	{
		assert(!(MvexInfo(code)).GetIgnoresOpMaskRegister());
		assert((MvexInfo(code)).GetCanUseEvictionHint());
		assert(!(MvexInfo(code)).GetIgnoresEvictionHint());
	...
	inline void OpCodeHandler_MVEX_HWIb::Decode(Decoder& decoder, Instruction& instruction) const
	{
		auto& state = decoder.state;
		assert(state.GetEncoding() == EncodingKind::MVEX);
		instruction.SetCode(code);
	...
	constexpr OpCodeHandler_MVEX_VWIb::OpCodeHandler_MVEX_VWIb(Code code)
	{
		assert(!(MvexInfo(code)).GetIgnoresOpMaskRegister());
		assert((MvexInfo(code)).GetCanUseEvictionHint());
		assert(!(MvexInfo(code)).GetIgnoresEvictionHint());
	...
	inline void OpCodeHandler_MVEX_VWIb::Decode(Decoder& decoder, Instruction& instruction) const
	{
		auto& state = decoder.state;
		assert(state.GetEncoding() == EncodingKind::MVEX);
		if ((state.vvvv_invalidCheck & decoder.invalidCheckMask) != 0)
	...
	constexpr OpCodeHandler_MVEX_VHW::OpCodeHandler_MVEX_VHW(Code code)
	{
		assert(!(MvexInfo(code)).GetIgnoresOpMaskRegister());
		assert((MvexInfo(code)).GetCanUseEvictionHint());
		assert(!(MvexInfo(code)).GetIgnoresEvictionHint());
	...
	inline void OpCodeHandler_MVEX_VHW::Decode(Decoder& decoder, Instruction& instruction) const
	{
		auto& state = decoder.state;
		assert(state.GetEncoding() == EncodingKind::MVEX);
		instruction.SetCode(code);
	...
	constexpr OpCodeHandler_MVEX_VHWIb::OpCodeHandler_MVEX_VHWIb(Code code)
	{
		assert(!(MvexInfo(code)).GetIgnoresOpMaskRegister());
		assert((MvexInfo(code)).GetCanUseEvictionHint());
		assert(!(MvexInfo(code)).GetIgnoresEvictionHint());
	...
	inline void OpCodeHandler_MVEX_VHWIb::Decode(Decoder& decoder, Instruction& instruction) const
	{
		auto& state = decoder.state;
		assert(state.GetEncoding() == EncodingKind::MVEX);
		instruction.SetCode(code);
	...
	constexpr OpCodeHandler_MVEX_VKW::OpCodeHandler_MVEX_VKW(Code code)
	{
		assert(!(MvexInfo(code)).GetIgnoresOpMaskRegister());
		assert((MvexInfo(code)).GetCanUseEvictionHint());
		assert(!(MvexInfo(code)).GetIgnoresEvictionHint());
	...
	inline void OpCodeHandler_MVEX_VKW::Decode(Decoder& decoder, Instruction& instruction) const
	{
		auto& state = decoder.state;
		assert(state.GetEncoding() == EncodingKind::MVEX);
	...
	constexpr OpCodeHandler_MVEX_KHW::OpCodeHandler_MVEX_KHW(Code code)
	{
		assert(!(MvexInfo(code)).GetIgnoresOpMaskRegister());
		assert((MvexInfo(code)).GetCanUseEvictionHint());
		assert(!(MvexInfo(code)).GetIgnoresEvictionHint());
	...
	inline void OpCodeHandler_MVEX_KHW::Decode(Decoder& decoder, Instruction& instruction) const
	{
		auto& state = decoder.state;
		assert(state.GetEncoding() == EncodingKind::MVEX);
		instruction.SetCode(code);
	...
	constexpr OpCodeHandler_MVEX_KHWIb::OpCodeHandler_MVEX_KHWIb(Code code)
	{
		assert(!(MvexInfo(code)).GetIgnoresOpMaskRegister());
		assert((MvexInfo(code)).GetCanUseEvictionHint());
		assert(!(MvexInfo(code)).GetIgnoresEvictionHint());
	...
	inline void OpCodeHandler_MVEX_KHWIb::Decode(Decoder& decoder, Instruction& instruction) const
	{
		auto& state = decoder.state;
		assert(state.GetEncoding() == EncodingKind::MVEX);
		instruction.SetCode(code);
	...
	constexpr OpCodeHandler_MVEX_VSIB::OpCodeHandler_MVEX_VSIB(Code code)
	{
		assert(!(MvexInfo(code)).GetIgnoresOpMaskRegister());
		assert((MvexInfo(code)).GetCanUseEvictionHint());
		assert(!(MvexInfo(code)).GetIgnoresEvictionHint());
	...
	inline void OpCodeHandler_MVEX_VSIB::Decode(Decoder& decoder, Instruction& instruction) const
	{
		auto& state = decoder.state;
		assert(state.GetEncoding() == EncodingKind::MVEX);
	...
	constexpr OpCodeHandler_MVEX_VSIB_V::OpCodeHandler_MVEX_VSIB_V(Code code)
	{
		assert(!(MvexInfo(code)).GetIgnoresOpMaskRegister());
		assert((MvexInfo(code)).GetCanUseEvictionHint());
		assert(!(MvexInfo(code)).GetIgnoresEvictionHint());
	...
	inline void OpCodeHandler_MVEX_VSIB_V::Decode(Decoder& decoder, Instruction& instruction) const
	{
		auto& state = decoder.state;
		assert(state.GetEncoding() == EncodingKind::MVEX);
		if (decoder.invalidCheckMask != 0 && ((state.vvvv_invalidCheck & 0xF) != 0 || state.aaa == 0))
	...
	constexpr OpCodeHandler_MVEX_V_VSIB::OpCodeHandler_MVEX_V_VSIB(Code code)
	{
		assert(!(MvexInfo(code)).GetIgnoresOpMaskRegister());
		assert((MvexInfo(code)).GetCanUseEvictionHint());
		assert(!(MvexInfo(code)).GetIgnoresEvictionHint());
	...
	inline void OpCodeHandler_MVEX_V_VSIB::Decode(Decoder& decoder, Instruction& instruction) const
	{
		auto& state = decoder.state;
		assert(state.GetEncoding() == EncodingKind::MVEX);
		if (decoder.invalidCheckMask != 0 && ((state.vvvv_invalidCheck & 0xF) != 0 || state.aaa == 0))
