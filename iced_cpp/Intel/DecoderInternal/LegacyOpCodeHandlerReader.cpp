...
namespace Iced::Intel::DecoderInternal
{
	...
	std::int32_t LegacyOpCodeHandlerReader::ReadHandlers(TableDeserializer& deserializer, std::vector<OpCodeHandler*>& result, std::int32_t resultIndex)
	{
		...
		case LegacyOpCodeHandlerKind::AnotherTable:
			elem = new OpCodeHandler_AnotherTable(deserializer.ReadArrayReference(static_cast<std::uint32_t>(LegacyOpCodeHandlerKind::ArrayReference)));
			return 1;
		case LegacyOpCodeHandlerKind::Group:
			elem = new OpCodeHandler_Group(deserializer.ReadArrayReference(static_cast<std::uint32_t>(LegacyOpCodeHandlerKind::ArrayReference)));
			return 1;
		case LegacyOpCodeHandlerKind::Group8x64:
			elem = new OpCodeHandler_Group8x64(deserializer.ReadArrayReference(static_cast<std::uint32_t>(LegacyOpCodeHandlerKind::ArrayReference)), deserializer.ReadArrayReference(static_cast<std::uint32_t>(LegacyOpCodeHandlerKind::ArrayReference)));
			return 1;
		case LegacyOpCodeHandlerKind::Group8x8:
			elem = new OpCodeHandler_Group8x8(deserializer.ReadArrayReference(static_cast<std::uint32_t>(LegacyOpCodeHandlerKind::ArrayReference)), deserializer.ReadArrayReference(static_cast<std::uint32_t>(LegacyOpCodeHandlerKind::ArrayReference)));
			return 1;
		...
		case LegacyOpCodeHandlerKind::MandatoryPrefix4:
			elem = new OpCodeHandler_MandatoryPrefix4(deserializer.ReadHandler(), deserializer.ReadHandler(), deserializer.ReadHandler(), deserializer.ReadHandler(), static_cast<std::uint32_t>(deserializer.ReadInt32()));
			return 1;
		...
		case LegacyOpCodeHandlerKind::Ev_REXW_1a:
			code = deserializer.ReadCode();
			elem = new OpCodeHandler_Ev_REXW(code, Code::INVALID, static_cast<std::uint32_t>(deserializer.ReadInt32()));
			return 1;
		case LegacyOpCodeHandlerKind::Ev_REXW:
			code = deserializer.ReadCode();
			elem = new OpCodeHandler_Ev_REXW(code, code + 1, static_cast<std::uint32_t>(deserializer.ReadInt32()));
			return 1;
		...
		case LegacyOpCodeHandlerKind::PrefixREX:
			elem = new OpCodeHandler_PrefixREX(deserializer.ReadHandler(), static_cast<std::uint32_t>(deserializer.ReadInt32()));
			return 1;
		default:
			throw InvalidOperationException();
		}
