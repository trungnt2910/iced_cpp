...
namespace Iced::Intel::DecoderInternal
{
	...
	{
	public:
		static std::vector<const OpCodeHandler*> Handlers_MAP8;
		static std::vector<const OpCodeHandler*> Handlers_MAP9;
		static std::vector<const OpCodeHandler*> Handlers_MAP10;
	private:
