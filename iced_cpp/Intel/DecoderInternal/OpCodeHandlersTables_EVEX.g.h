...
inline static constexpr std::array SerializedTables = 
...
inline static constexpr std::int32_t MaxIdNames = 10;
inline static constexpr std::uint32_t Handlers_0FIndex = 9;
inline static constexpr std::uint32_t Handlers_0F38Index = 5;
inline static constexpr std::uint32_t Handlers_0F3AIndex = 6;
inline static constexpr std::uint32_t Handlers_MAP5Index = 7;
inline static constexpr std::uint32_t Handlers_MAP6Index = 8;
