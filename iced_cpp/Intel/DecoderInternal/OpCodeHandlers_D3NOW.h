...
{
	class OpCodeHandler_D3NOW_Internal
	{
	private:
		friend class OpCodeHandler_D3NOW;
		static constexpr auto CreateCodeValues()
		{
			auto result = std::array<Code, 0x100>();
		...
		constexpr OpCodeHandler_D3NOW_Internal() = default;
	};

	class OpCodeHandler_D3NOW final : public OpCodeHandlerModRM
	{
	public:
		inline static constexpr std::array<Code, 0x100> CodeValues = OpCodeHandler_D3NOW_Internal::CreateCodeValues();
	public:
		void Decode(Decoder& decoder, Instruction& instruction) const override;
	};
}

namespace Iced::Intel::DecoderInternal
{
	inline void OpCodeHandler_D3NOW::Decode(Decoder& decoder, Instruction& instruction) const
	{
