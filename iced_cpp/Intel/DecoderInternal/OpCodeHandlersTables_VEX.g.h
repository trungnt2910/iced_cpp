...
inline static constexpr std::int32_t MaxIdNames = 16;
inline static constexpr std::uint32_t Handlers_MAP0Index = 14;
inline static constexpr std::uint32_t Handlers_0FIndex = 15;
inline static constexpr std::uint32_t Handlers_0F38Index = 12;
inline static constexpr std::uint32_t Handlers_0F3AIndex = 13;
