...
inline static constexpr std::int32_t MaxIdNames = 7;
inline static constexpr std::uint32_t Handlers_MAP8Index = 4;
inline static constexpr std::uint32_t Handlers_MAP9Index = 5;
inline static constexpr std::uint32_t Handlers_MAP10Index = 6;
