...
namespace Iced::Intel::DecoderInternal
{
	...
	std::int32_t VexOpCodeHandlerReader::ReadHandlers(TableDeserializer& deserializer, std::vector<OpCodeHandler*>& result, std::int32_t resultIndex)
	{
		...
		case VexOpCodeHandlerKind::Group:
			elem = new OpCodeHandler_Group(deserializer.ReadArrayReference(static_cast<std::uint32_t>(VexOpCodeHandlerKind::ArrayReference)));
			return 1;
		case VexOpCodeHandlerKind::Group8x64:
			elem = new OpCodeHandler_Group8x64(deserializer.ReadArrayReference(static_cast<std::uint32_t>(VexOpCodeHandlerKind::ArrayReference)), deserializer.ReadArrayReference(static_cast<std::uint32_t>(VexOpCodeHandlerKind::ArrayReference)));
			return 1;
