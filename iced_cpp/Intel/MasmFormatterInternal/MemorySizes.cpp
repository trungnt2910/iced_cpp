...
namespace Iced::Intel::MasmFormatterInternal
{
	...
	MemorySizes::Info::Info(bool isBroadcast, std::int32_t size, std::vector<FormatterString>& keywords)
	{
