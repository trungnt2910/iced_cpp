...
namespace Iced::Intel::MasmFormatterInternal
{
	...
	InstrOpInfo::InstrOpInfo(FormatterString mnemonic, Instruction const instruction, InstrOpInfoFlags flags)
	{
	...
	void SimpleInstrInfo::GetOpInfo(FormatterOptions* options, Instruction const instruction, InstrOpInfo& info)
	{
		info = InstrOpInfo(mnemonic, instruction, flags);
	}

	SimpleInstrInfo_cc::SimpleInstrInfo_cc(std::int32_t ccIndex, std::vector<std::string>& mnemonics) : SimpleInstrInfo_cc(ccIndex, mnemonics, InstrOpInfoFlags::None)
	{
	}

	SimpleInstrInfo_cc::SimpleInstrInfo_cc(std::int32_t ccIndex, std::vector<std::string>& mnemonics, InstrOpInfoFlags flags)
	{
	...
	void SimpleInstrInfo_cc::GetOpInfo(FormatterOptions* options, Instruction const instruction, InstrOpInfo& info)
	{
	...
	void SimpleInstrInfo_memsize::GetOpInfo(FormatterOptions* options, Instruction const instruction, InstrOpInfo& info)
	{
	...
	void SimpleInstrInfo_AamAad::GetOpInfo(FormatterOptions* options, Instruction const instruction, InstrOpInfo& info)
	{
	...
	void SimpleInstrInfo_Int3::GetOpInfo(FormatterOptions* options, Instruction const instruction, InstrOpInfo& info)
	{
		info = Iced::Intel::GasFormatterInternal::InstrOpInfo();
		info.Mnemonic = mnemonic;
		info.OpCount = 1;
	...
	void SimpleInstrInfo_YD::GetOpInfo(FormatterOptions* options, Instruction const instruction, InstrOpInfo& info)
	{
	...
	void SimpleInstrInfo_DX::GetOpInfo(FormatterOptions* options, Instruction const instruction, InstrOpInfo& info)
	{
	...
	void SimpleInstrInfo_YX::GetOpInfo(FormatterOptions* options, Instruction const instruction, InstrOpInfo& info)
	{
	...
	void SimpleInstrInfo_XY::GetOpInfo(FormatterOptions* options, Instruction const instruction, InstrOpInfo& info)
	{
	...
	void SimpleInstrInfo_YA::GetOpInfo(FormatterOptions* options, Instruction const instruction, InstrOpInfo& info)
	{
	...
	void SimpleInstrInfo_AX::GetOpInfo(FormatterOptions* options, Instruction const instruction, InstrOpInfo& info)
	{
	...
	void SimpleInstrInfo_AY::GetOpInfo(FormatterOptions* options, Instruction const instruction, InstrOpInfo& info)
	{
	...
	void SimpleInstrInfo_XLAT::GetOpInfo(FormatterOptions* options, Instruction const instruction, InstrOpInfo& info)
	{
	...
	void SimpleInstrInfo_nop::GetOpInfo(FormatterOptions* options, Instruction const instruction, InstrOpInfo& info)
	{
		std::int32_t instrBitness = GetBitness(instruction.GetCodeSize());
		...
		else
		{
			...
			info.OpCount = 2;
			Static::Assert(InstrOpKind::Register == (Iced::Intel::GasFormatterInternal::InstrOpKind)0 ? 0 : -1);
	...
	void SimpleInstrInfo_STIG1::GetOpInfo(FormatterOptions* options, Instruction const instruction, InstrOpInfo& info)
	{
		info = Iced::Intel::GasFormatterInternal::InstrOpInfo();
		info.Mnemonic = mnemonic;
	...
	void SimpleInstrInfo_monitor::GetOpInfo(FormatterOptions* options, Instruction const instruction, InstrOpInfo& info)
	{
		info = Iced::Intel::GasFormatterInternal::InstrOpInfo();
		info.Mnemonic = mnemonic;
		info.OpCount = 3;
	...
	void SimpleInstrInfo_mwait::GetOpInfo(FormatterOptions* options, Instruction const instruction, InstrOpInfo& info)
	{
		info = Iced::Intel::GasFormatterInternal::InstrOpInfo();
		info.Mnemonic = mnemonic;
		info.OpCount = 2;
	...
	void SimpleInstrInfo_mwaitx::GetOpInfo(FormatterOptions* options, Instruction const instruction, InstrOpInfo& info)
	{
		info = Iced::Intel::GasFormatterInternal::InstrOpInfo();
		info.Mnemonic = mnemonic;
		info.OpCount = 3;
	...
	void SimpleInstrInfo_maskmovq::GetOpInfo(FormatterOptions* options, Instruction const instruction, InstrOpInfo& info)
	{
	...
	void SimpleInstrInfo_pblendvb::GetOpInfo(FormatterOptions* options, Instruction const instruction, InstrOpInfo& info)
	{
		info = Iced::Intel::GasFormatterInternal::InstrOpInfo();
		assert(instruction.GetOpCount() == 2);
		info.Mnemonic = mnemonic;
	...
	void SimpleInstrInfo_reverse::GetOpInfo(FormatterOptions* options, Instruction const instruction, InstrOpInfo& info)
	{
		info = Iced::Intel::GasFormatterInternal::InstrOpInfo();
		info.Mnemonic = mnemonic;
		assert(instruction.GetOpCount() == 2);
	...
	void SimpleInstrInfo_OpSize::GetOpInfo(FormatterOptions* options, Instruction const instruction, InstrOpInfo& info)
	{
	...
	SimpleInstrInfo_OpSize_cc::SimpleInstrInfo_OpSize_cc(CodeSize codeSize, std::int32_t ccIndex, std::vector<std::string>& mnemonics, std::vector<std::string>& mnemonics_other)
	{
		this->codeSize = codeSize;
		this->ccIndex = ccIndex;
		this->mnemonics = FormatterString::Create(mnemonics);
	...
	void SimpleInstrInfo_OpSize_cc::GetOpInfo(FormatterOptions* options, Instruction const instruction, InstrOpInfo& info)
	{
	...
	void SimpleInstrInfo_OpSize2::GetOpInfo(FormatterOptions* options, Instruction const instruction, InstrOpInfo& info)
	{
	...
	void SimpleInstrInfo_fword::GetOpInfo(FormatterOptions* options, Instruction const instruction, InstrOpInfo& info)
	{
		FormatterString mnemonic;
	...
	SimpleInstrInfo_jcc::SimpleInstrInfo_jcc(std::int32_t ccIndex, std::vector<std::string>& mnemonics)
	{
		this->ccIndex = ccIndex;
		this->mnemonics = FormatterString::Create(mnemonics);
	}

	void SimpleInstrInfo_jcc::GetOpInfo(FormatterOptions* options, Instruction const instruction, InstrOpInfo& info)
	{
		auto flags = InstrOpInfoFlags::None;
	...
	void SimpleInstrInfo_bnd::GetOpInfo(FormatterOptions* options, Instruction const instruction, InstrOpInfo& info)
	{
	...
	SimpleInstrInfo_pops::SimpleInstrInfo_pops(const std::string& mnemonic, std::vector<FormatterString>& pseudo_ops) : SimpleInstrInfo_pops(mnemonic, pseudo_ops, InstrOpInfoFlags::None)
	{
	}

	SimpleInstrInfo_pops::SimpleInstrInfo_pops(const std::string& mnemonic, std::vector<FormatterString>& pseudo_ops, InstrOpInfoFlags flags)
	{
		this->mnemonic = FormatterString(mnemonic);
	...
	void SimpleInstrInfo_pops::GetOpInfo(FormatterOptions* options, Instruction const instruction, InstrOpInfo& info)
	{
		info = InstrOpInfo(mnemonic, instruction, flags);
	...
	void SimpleInstrInfo_pclmulqdq::GetOpInfo(FormatterOptions* options, Instruction const instruction, InstrOpInfo& info)
	{
		info = InstrOpInfo(mnemonic, instruction, InstrOpInfoFlags::None);
	...
	void SimpleInstrInfo_imul::GetOpInfo(FormatterOptions* options, Instruction const instruction, InstrOpInfo& info)
	{
		info = InstrOpInfo(mnemonic, instruction, InstrOpInfoFlags::None);
	...
	void SimpleInstrInfo_Reg16::GetOpInfo(FormatterOptions* options, Instruction const instruction, InstrOpInfo& info)
	{
		info = InstrOpInfo(mnemonic, instruction, flags);
	...
	void SimpleInstrInfo_Reg32::GetOpInfo(FormatterOptions* options, Instruction const instruction, InstrOpInfo& info)
	{
		info = InstrOpInfo(mnemonic, instruction, flags);
	...
	void SimpleInstrInfo_reg::GetOpInfo(FormatterOptions* options, Instruction const instruction, InstrOpInfo& info)
	{
		info = Iced::Intel::GasFormatterInternal::InstrOpInfo();
		info.Mnemonic = mnemonic;
		info.OpCount = 1;
	...
	void SimpleInstrInfo_DeclareData::GetOpInfo(FormatterOptions* options, Instruction const instruction, InstrOpInfo& info)
	{
