...
namespace Iced::Intel
{
	...
	constexpr int operator+(const NumberBase& a, const NumberBase& b) { return ((int)a + (int)b); }
	constexpr int operator+(const NumberBase& a, const int& b) { return ((int)a + b); }
	constexpr int operator+(const int& a, const NumberBase& b) { return (a + (int)b); }
	constexpr int operator-(const NumberBase& a, const NumberBase& b) { return ((int)a - (int)b); }
	constexpr int operator-(const NumberBase& a, const int& b) { return ((int)a - b); }
	constexpr int operator-(const int& a, const NumberBase& b) { return (a - (int)b); }
	constexpr NumberBase operator++(NumberBase& a, int) { auto temp = a; a = NumberBase(a + 1); return temp; }
	constexpr NumberBase& operator++(NumberBase& a) { return a = NumberBase(a + 1); }
	constexpr NumberBase operator--(NumberBase& a, int) { auto temp = a; a = NumberBase(a - 1); return temp; }
	constexpr NumberBase& operator--(NumberBase& a) { return a = NumberBase(a - 1); }
	constexpr bool operator==(const NumberBase& a, const int& b) { return ((int)a == b); }
	constexpr bool operator==(const int& a, const NumberBase& b) { return (a == (int)b); }
	constexpr bool operator>=(const NumberBase& a, const int& b) { return ((int)a >= b); }
	constexpr bool operator>=(const int& a, const NumberBase& b) { return (a >= (int)b); }
	constexpr bool operator<=(const NumberBase& a, const int& b) { return ((int)a <= b); }
	constexpr bool operator<=(const int& a, const NumberBase& b) { return (a <= (int)b); }
	...
	constexpr std::uint8_t operator+(const CC_b& a, const CC_b& b) { return ((std::uint8_t)a + (std::uint8_t)b); }
	constexpr std::uint8_t operator+(const CC_b& a, const std::uint8_t& b) { return ((std::uint8_t)a + b); }
	constexpr std::uint8_t operator+(const std::uint8_t& a, const CC_b& b) { return (a + (std::uint8_t)b); }
	constexpr std::uint8_t operator-(const CC_b& a, const CC_b& b) { return ((std::uint8_t)a - (std::uint8_t)b); }
	constexpr std::uint8_t operator-(const CC_b& a, const std::uint8_t& b) { return ((std::uint8_t)a - b); }
	constexpr std::uint8_t operator-(const std::uint8_t& a, const CC_b& b) { return (a - (std::uint8_t)b); }
	constexpr CC_b operator++(CC_b& a, int) { auto temp = a; a = CC_b(a + 1); return temp; }
	constexpr CC_b& operator++(CC_b& a) { return a = CC_b(a + 1); }
	constexpr CC_b operator--(CC_b& a, int) { auto temp = a; a = CC_b(a - 1); return temp; }
	constexpr CC_b& operator--(CC_b& a) { return a = CC_b(a - 1); }
	constexpr bool operator==(const CC_b& a, const std::uint8_t& b) { return ((std::uint8_t)a == b); }
	constexpr bool operator==(const std::uint8_t& a, const CC_b& b) { return (a == (std::uint8_t)b); }
	constexpr bool operator>=(const CC_b& a, const std::uint8_t& b) { return ((std::uint8_t)a >= b); }
	constexpr bool operator>=(const std::uint8_t& a, const CC_b& b) { return (a >= (std::uint8_t)b); }
	constexpr bool operator<=(const CC_b& a, const std::uint8_t& b) { return ((std::uint8_t)a <= b); }
	constexpr bool operator<=(const std::uint8_t& a, const CC_b& b) { return (a <= (std::uint8_t)b); }
	...
	constexpr std::uint8_t operator+(const CC_ae& a, const CC_ae& b) { return ((std::uint8_t)a + (std::uint8_t)b); }
	constexpr std::uint8_t operator+(const CC_ae& a, const std::uint8_t& b) { return ((std::uint8_t)a + b); }
	constexpr std::uint8_t operator+(const std::uint8_t& a, const CC_ae& b) { return (a + (std::uint8_t)b); }
	constexpr std::uint8_t operator-(const CC_ae& a, const CC_ae& b) { return ((std::uint8_t)a - (std::uint8_t)b); }
	constexpr std::uint8_t operator-(const CC_ae& a, const std::uint8_t& b) { return ((std::uint8_t)a - b); }
	constexpr std::uint8_t operator-(const std::uint8_t& a, const CC_ae& b) { return (a - (std::uint8_t)b); }
	constexpr CC_ae operator++(CC_ae& a, int) { auto temp = a; a = CC_ae(a + 1); return temp; }
	constexpr CC_ae& operator++(CC_ae& a) { return a = CC_ae(a + 1); }
	constexpr CC_ae operator--(CC_ae& a, int) { auto temp = a; a = CC_ae(a - 1); return temp; }
	constexpr CC_ae& operator--(CC_ae& a) { return a = CC_ae(a - 1); }
	constexpr bool operator==(const CC_ae& a, const std::uint8_t& b) { return ((std::uint8_t)a == b); }
	constexpr bool operator==(const std::uint8_t& a, const CC_ae& b) { return (a == (std::uint8_t)b); }
	constexpr bool operator>=(const CC_ae& a, const std::uint8_t& b) { return ((std::uint8_t)a >= b); }
	constexpr bool operator>=(const std::uint8_t& a, const CC_ae& b) { return (a >= (std::uint8_t)b); }
	constexpr bool operator<=(const CC_ae& a, const std::uint8_t& b) { return ((std::uint8_t)a <= b); }
	constexpr bool operator<=(const std::uint8_t& a, const CC_ae& b) { return (a <= (std::uint8_t)b); }
	...
	constexpr std::uint8_t operator+(const CC_e& a, const CC_e& b) { return ((std::uint8_t)a + (std::uint8_t)b); }
	constexpr std::uint8_t operator+(const CC_e& a, const std::uint8_t& b) { return ((std::uint8_t)a + b); }
	constexpr std::uint8_t operator+(const std::uint8_t& a, const CC_e& b) { return (a + (std::uint8_t)b); }
	constexpr std::uint8_t operator-(const CC_e& a, const CC_e& b) { return ((std::uint8_t)a - (std::uint8_t)b); }
	constexpr std::uint8_t operator-(const CC_e& a, const std::uint8_t& b) { return ((std::uint8_t)a - b); }
	constexpr std::uint8_t operator-(const std::uint8_t& a, const CC_e& b) { return (a - (std::uint8_t)b); }
	constexpr CC_e operator++(CC_e& a, int) { auto temp = a; a = CC_e(a + 1); return temp; }
	constexpr CC_e& operator++(CC_e& a) { return a = CC_e(a + 1); }
	constexpr CC_e operator--(CC_e& a, int) { auto temp = a; a = CC_e(a - 1); return temp; }
	constexpr CC_e& operator--(CC_e& a) { return a = CC_e(a - 1); }
	constexpr bool operator==(const CC_e& a, const std::uint8_t& b) { return ((std::uint8_t)a == b); }
	constexpr bool operator==(const std::uint8_t& a, const CC_e& b) { return (a == (std::uint8_t)b); }
	constexpr bool operator>=(const CC_e& a, const std::uint8_t& b) { return ((std::uint8_t)a >= b); }
	constexpr bool operator>=(const std::uint8_t& a, const CC_e& b) { return (a >= (std::uint8_t)b); }
	constexpr bool operator<=(const CC_e& a, const std::uint8_t& b) { return ((std::uint8_t)a <= b); }
	constexpr bool operator<=(const std::uint8_t& a, const CC_e& b) { return (a <= (std::uint8_t)b); }
	...
	constexpr std::uint8_t operator+(const CC_ne& a, const CC_ne& b) { return ((std::uint8_t)a + (std::uint8_t)b); }
	constexpr std::uint8_t operator+(const CC_ne& a, const std::uint8_t& b) { return ((std::uint8_t)a + b); }
	constexpr std::uint8_t operator+(const std::uint8_t& a, const CC_ne& b) { return (a + (std::uint8_t)b); }
	constexpr std::uint8_t operator-(const CC_ne& a, const CC_ne& b) { return ((std::uint8_t)a - (std::uint8_t)b); }
	constexpr std::uint8_t operator-(const CC_ne& a, const std::uint8_t& b) { return ((std::uint8_t)a - b); }
	constexpr std::uint8_t operator-(const std::uint8_t& a, const CC_ne& b) { return (a - (std::uint8_t)b); }
	constexpr CC_ne operator++(CC_ne& a, int) { auto temp = a; a = CC_ne(a + 1); return temp; }
	constexpr CC_ne& operator++(CC_ne& a) { return a = CC_ne(a + 1); }
	constexpr CC_ne operator--(CC_ne& a, int) { auto temp = a; a = CC_ne(a - 1); return temp; }
	constexpr CC_ne& operator--(CC_ne& a) { return a = CC_ne(a - 1); }
	constexpr bool operator==(const CC_ne& a, const std::uint8_t& b) { return ((std::uint8_t)a == b); }
	constexpr bool operator==(const std::uint8_t& a, const CC_ne& b) { return (a == (std::uint8_t)b); }
	constexpr bool operator>=(const CC_ne& a, const std::uint8_t& b) { return ((std::uint8_t)a >= b); }
	constexpr bool operator>=(const std::uint8_t& a, const CC_ne& b) { return (a >= (std::uint8_t)b); }
	constexpr bool operator<=(const CC_ne& a, const std::uint8_t& b) { return ((std::uint8_t)a <= b); }
	constexpr bool operator<=(const std::uint8_t& a, const CC_ne& b) { return (a <= (std::uint8_t)b); }
	...
	constexpr std::uint8_t operator+(const CC_be& a, const CC_be& b) { return ((std::uint8_t)a + (std::uint8_t)b); }
	constexpr std::uint8_t operator+(const CC_be& a, const std::uint8_t& b) { return ((std::uint8_t)a + b); }
	constexpr std::uint8_t operator+(const std::uint8_t& a, const CC_be& b) { return (a + (std::uint8_t)b); }
	constexpr std::uint8_t operator-(const CC_be& a, const CC_be& b) { return ((std::uint8_t)a - (std::uint8_t)b); }
	constexpr std::uint8_t operator-(const CC_be& a, const std::uint8_t& b) { return ((std::uint8_t)a - b); }
	constexpr std::uint8_t operator-(const std::uint8_t& a, const CC_be& b) { return (a - (std::uint8_t)b); }
	constexpr CC_be operator++(CC_be& a, int) { auto temp = a; a = CC_be(a + 1); return temp; }
	constexpr CC_be& operator++(CC_be& a) { return a = CC_be(a + 1); }
	constexpr CC_be operator--(CC_be& a, int) { auto temp = a; a = CC_be(a - 1); return temp; }
	constexpr CC_be& operator--(CC_be& a) { return a = CC_be(a - 1); }
	constexpr bool operator==(const CC_be& a, const std::uint8_t& b) { return ((std::uint8_t)a == b); }
	constexpr bool operator==(const std::uint8_t& a, const CC_be& b) { return (a == (std::uint8_t)b); }
	constexpr bool operator>=(const CC_be& a, const std::uint8_t& b) { return ((std::uint8_t)a >= b); }
	constexpr bool operator>=(const std::uint8_t& a, const CC_be& b) { return (a >= (std::uint8_t)b); }
	constexpr bool operator<=(const CC_be& a, const std::uint8_t& b) { return ((std::uint8_t)a <= b); }
	constexpr bool operator<=(const std::uint8_t& a, const CC_be& b) { return (a <= (std::uint8_t)b); }
	...
	constexpr std::uint8_t operator+(const CC_a& a, const CC_a& b) { return ((std::uint8_t)a + (std::uint8_t)b); }
	constexpr std::uint8_t operator+(const CC_a& a, const std::uint8_t& b) { return ((std::uint8_t)a + b); }
	constexpr std::uint8_t operator+(const std::uint8_t& a, const CC_a& b) { return (a + (std::uint8_t)b); }
	constexpr std::uint8_t operator-(const CC_a& a, const CC_a& b) { return ((std::uint8_t)a - (std::uint8_t)b); }
	constexpr std::uint8_t operator-(const CC_a& a, const std::uint8_t& b) { return ((std::uint8_t)a - b); }
	constexpr std::uint8_t operator-(const std::uint8_t& a, const CC_a& b) { return (a - (std::uint8_t)b); }
	constexpr CC_a operator++(CC_a& a, int) { auto temp = a; a = CC_a(a + 1); return temp; }
	constexpr CC_a& operator++(CC_a& a) { return a = CC_a(a + 1); }
	constexpr CC_a operator--(CC_a& a, int) { auto temp = a; a = CC_a(a - 1); return temp; }
	constexpr CC_a& operator--(CC_a& a) { return a = CC_a(a - 1); }
	constexpr bool operator==(const CC_a& a, const std::uint8_t& b) { return ((std::uint8_t)a == b); }
	constexpr bool operator==(const std::uint8_t& a, const CC_a& b) { return (a == (std::uint8_t)b); }
	constexpr bool operator>=(const CC_a& a, const std::uint8_t& b) { return ((std::uint8_t)a >= b); }
	constexpr bool operator>=(const std::uint8_t& a, const CC_a& b) { return (a >= (std::uint8_t)b); }
	constexpr bool operator<=(const CC_a& a, const std::uint8_t& b) { return ((std::uint8_t)a <= b); }
	constexpr bool operator<=(const std::uint8_t& a, const CC_a& b) { return (a <= (std::uint8_t)b); }
	...
	constexpr std::uint8_t operator+(const CC_p& a, const CC_p& b) { return ((std::uint8_t)a + (std::uint8_t)b); }
	constexpr std::uint8_t operator+(const CC_p& a, const std::uint8_t& b) { return ((std::uint8_t)a + b); }
	constexpr std::uint8_t operator+(const std::uint8_t& a, const CC_p& b) { return (a + (std::uint8_t)b); }
	constexpr std::uint8_t operator-(const CC_p& a, const CC_p& b) { return ((std::uint8_t)a - (std::uint8_t)b); }
	constexpr std::uint8_t operator-(const CC_p& a, const std::uint8_t& b) { return ((std::uint8_t)a - b); }
	constexpr std::uint8_t operator-(const std::uint8_t& a, const CC_p& b) { return (a - (std::uint8_t)b); }
	constexpr CC_p operator++(CC_p& a, int) { auto temp = a; a = CC_p(a + 1); return temp; }
	constexpr CC_p& operator++(CC_p& a) { return a = CC_p(a + 1); }
	constexpr CC_p operator--(CC_p& a, int) { auto temp = a; a = CC_p(a - 1); return temp; }
	constexpr CC_p& operator--(CC_p& a) { return a = CC_p(a - 1); }
	constexpr bool operator==(const CC_p& a, const std::uint8_t& b) { return ((std::uint8_t)a == b); }
	constexpr bool operator==(const std::uint8_t& a, const CC_p& b) { return (a == (std::uint8_t)b); }
	constexpr bool operator>=(const CC_p& a, const std::uint8_t& b) { return ((std::uint8_t)a >= b); }
	constexpr bool operator>=(const std::uint8_t& a, const CC_p& b) { return (a >= (std::uint8_t)b); }
	constexpr bool operator<=(const CC_p& a, const std::uint8_t& b) { return ((std::uint8_t)a <= b); }
	constexpr bool operator<=(const std::uint8_t& a, const CC_p& b) { return (a <= (std::uint8_t)b); }
	...
	constexpr std::uint8_t operator+(const CC_np& a, const CC_np& b) { return ((std::uint8_t)a + (std::uint8_t)b); }
	constexpr std::uint8_t operator+(const CC_np& a, const std::uint8_t& b) { return ((std::uint8_t)a + b); }
	constexpr std::uint8_t operator+(const std::uint8_t& a, const CC_np& b) { return (a + (std::uint8_t)b); }
	constexpr std::uint8_t operator-(const CC_np& a, const CC_np& b) { return ((std::uint8_t)a - (std::uint8_t)b); }
	constexpr std::uint8_t operator-(const CC_np& a, const std::uint8_t& b) { return ((std::uint8_t)a - b); }
	constexpr std::uint8_t operator-(const std::uint8_t& a, const CC_np& b) { return (a - (std::uint8_t)b); }
	constexpr CC_np operator++(CC_np& a, int) { auto temp = a; a = CC_np(a + 1); return temp; }
	constexpr CC_np& operator++(CC_np& a) { return a = CC_np(a + 1); }
	constexpr CC_np operator--(CC_np& a, int) { auto temp = a; a = CC_np(a - 1); return temp; }
	constexpr CC_np& operator--(CC_np& a) { return a = CC_np(a - 1); }
	constexpr bool operator==(const CC_np& a, const std::uint8_t& b) { return ((std::uint8_t)a == b); }
	constexpr bool operator==(const std::uint8_t& a, const CC_np& b) { return (a == (std::uint8_t)b); }
	constexpr bool operator>=(const CC_np& a, const std::uint8_t& b) { return ((std::uint8_t)a >= b); }
	constexpr bool operator>=(const std::uint8_t& a, const CC_np& b) { return (a >= (std::uint8_t)b); }
	constexpr bool operator<=(const CC_np& a, const std::uint8_t& b) { return ((std::uint8_t)a <= b); }
	constexpr bool operator<=(const std::uint8_t& a, const CC_np& b) { return (a <= (std::uint8_t)b); }
	...
	constexpr std::uint8_t operator+(const CC_l& a, const CC_l& b) { return ((std::uint8_t)a + (std::uint8_t)b); }
	constexpr std::uint8_t operator+(const CC_l& a, const std::uint8_t& b) { return ((std::uint8_t)a + b); }
	constexpr std::uint8_t operator+(const std::uint8_t& a, const CC_l& b) { return (a + (std::uint8_t)b); }
	constexpr std::uint8_t operator-(const CC_l& a, const CC_l& b) { return ((std::uint8_t)a - (std::uint8_t)b); }
	constexpr std::uint8_t operator-(const CC_l& a, const std::uint8_t& b) { return ((std::uint8_t)a - b); }
	constexpr std::uint8_t operator-(const std::uint8_t& a, const CC_l& b) { return (a - (std::uint8_t)b); }
	constexpr CC_l operator++(CC_l& a, int) { auto temp = a; a = CC_l(a + 1); return temp; }
	constexpr CC_l& operator++(CC_l& a) { return a = CC_l(a + 1); }
	constexpr CC_l operator--(CC_l& a, int) { auto temp = a; a = CC_l(a - 1); return temp; }
	constexpr CC_l& operator--(CC_l& a) { return a = CC_l(a - 1); }
	constexpr bool operator==(const CC_l& a, const std::uint8_t& b) { return ((std::uint8_t)a == b); }
	constexpr bool operator==(const std::uint8_t& a, const CC_l& b) { return (a == (std::uint8_t)b); }
	constexpr bool operator>=(const CC_l& a, const std::uint8_t& b) { return ((std::uint8_t)a >= b); }
	constexpr bool operator>=(const std::uint8_t& a, const CC_l& b) { return (a >= (std::uint8_t)b); }
	constexpr bool operator<=(const CC_l& a, const std::uint8_t& b) { return ((std::uint8_t)a <= b); }
	constexpr bool operator<=(const std::uint8_t& a, const CC_l& b) { return (a <= (std::uint8_t)b); }
	...
	constexpr std::uint8_t operator+(const CC_ge& a, const CC_ge& b) { return ((std::uint8_t)a + (std::uint8_t)b); }
	constexpr std::uint8_t operator+(const CC_ge& a, const std::uint8_t& b) { return ((std::uint8_t)a + b); }
	constexpr std::uint8_t operator+(const std::uint8_t& a, const CC_ge& b) { return (a + (std::uint8_t)b); }
	constexpr std::uint8_t operator-(const CC_ge& a, const CC_ge& b) { return ((std::uint8_t)a - (std::uint8_t)b); }
	constexpr std::uint8_t operator-(const CC_ge& a, const std::uint8_t& b) { return ((std::uint8_t)a - b); }
	constexpr std::uint8_t operator-(const std::uint8_t& a, const CC_ge& b) { return (a - (std::uint8_t)b); }
	constexpr CC_ge operator++(CC_ge& a, int) { auto temp = a; a = CC_ge(a + 1); return temp; }
	constexpr CC_ge& operator++(CC_ge& a) { return a = CC_ge(a + 1); }
	constexpr CC_ge operator--(CC_ge& a, int) { auto temp = a; a = CC_ge(a - 1); return temp; }
	constexpr CC_ge& operator--(CC_ge& a) { return a = CC_ge(a - 1); }
	constexpr bool operator==(const CC_ge& a, const std::uint8_t& b) { return ((std::uint8_t)a == b); }
	constexpr bool operator==(const std::uint8_t& a, const CC_ge& b) { return (a == (std::uint8_t)b); }
	constexpr bool operator>=(const CC_ge& a, const std::uint8_t& b) { return ((std::uint8_t)a >= b); }
	constexpr bool operator>=(const std::uint8_t& a, const CC_ge& b) { return (a >= (std::uint8_t)b); }
	constexpr bool operator<=(const CC_ge& a, const std::uint8_t& b) { return ((std::uint8_t)a <= b); }
	constexpr bool operator<=(const std::uint8_t& a, const CC_ge& b) { return (a <= (std::uint8_t)b); }
	...
	constexpr std::uint8_t operator+(const CC_le& a, const CC_le& b) { return ((std::uint8_t)a + (std::uint8_t)b); }
	constexpr std::uint8_t operator+(const CC_le& a, const std::uint8_t& b) { return ((std::uint8_t)a + b); }
	constexpr std::uint8_t operator+(const std::uint8_t& a, const CC_le& b) { return (a + (std::uint8_t)b); }
	constexpr std::uint8_t operator-(const CC_le& a, const CC_le& b) { return ((std::uint8_t)a - (std::uint8_t)b); }
	constexpr std::uint8_t operator-(const CC_le& a, const std::uint8_t& b) { return ((std::uint8_t)a - b); }
	constexpr std::uint8_t operator-(const std::uint8_t& a, const CC_le& b) { return (a - (std::uint8_t)b); }
	constexpr CC_le operator++(CC_le& a, int) { auto temp = a; a = CC_le(a + 1); return temp; }
	constexpr CC_le& operator++(CC_le& a) { return a = CC_le(a + 1); }
	constexpr CC_le operator--(CC_le& a, int) { auto temp = a; a = CC_le(a - 1); return temp; }
	constexpr CC_le& operator--(CC_le& a) { return a = CC_le(a - 1); }
	constexpr bool operator==(const CC_le& a, const std::uint8_t& b) { return ((std::uint8_t)a == b); }
	constexpr bool operator==(const std::uint8_t& a, const CC_le& b) { return (a == (std::uint8_t)b); }
	constexpr bool operator>=(const CC_le& a, const std::uint8_t& b) { return ((std::uint8_t)a >= b); }
	constexpr bool operator>=(const std::uint8_t& a, const CC_le& b) { return (a >= (std::uint8_t)b); }
	constexpr bool operator<=(const CC_le& a, const std::uint8_t& b) { return ((std::uint8_t)a <= b); }
	constexpr bool operator<=(const std::uint8_t& a, const CC_le& b) { return (a <= (std::uint8_t)b); }
	...
	constexpr std::uint8_t operator+(const CC_g& a, const CC_g& b) { return ((std::uint8_t)a + (std::uint8_t)b); }
	constexpr std::uint8_t operator+(const CC_g& a, const std::uint8_t& b) { return ((std::uint8_t)a + b); }
	constexpr std::uint8_t operator+(const std::uint8_t& a, const CC_g& b) { return (a + (std::uint8_t)b); }
	constexpr std::uint8_t operator-(const CC_g& a, const CC_g& b) { return ((std::uint8_t)a - (std::uint8_t)b); }
	constexpr std::uint8_t operator-(const CC_g& a, const std::uint8_t& b) { return ((std::uint8_t)a - b); }
	constexpr std::uint8_t operator-(const std::uint8_t& a, const CC_g& b) { return (a - (std::uint8_t)b); }
	constexpr CC_g operator++(CC_g& a, int) { auto temp = a; a = CC_g(a + 1); return temp; }
	constexpr CC_g& operator++(CC_g& a) { return a = CC_g(a + 1); }
	constexpr CC_g operator--(CC_g& a, int) { auto temp = a; a = CC_g(a - 1); return temp; }
	constexpr CC_g& operator--(CC_g& a) { return a = CC_g(a - 1); }
	constexpr bool operator==(const CC_g& a, const std::uint8_t& b) { return ((std::uint8_t)a == b); }
	constexpr bool operator==(const std::uint8_t& a, const CC_g& b) { return (a == (std::uint8_t)b); }
	constexpr bool operator>=(const CC_g& a, const std::uint8_t& b) { return ((std::uint8_t)a >= b); }
	constexpr bool operator>=(const std::uint8_t& a, const CC_g& b) { return (a >= (std::uint8_t)b); }
	constexpr bool operator<=(const CC_g& a, const std::uint8_t& b) { return ((std::uint8_t)a <= b); }
	constexpr bool operator<=(const std::uint8_t& a, const CC_g& b) { return (a <= (std::uint8_t)b); }
	...
	private:
		...
		friend constexpr Flags1& operator^=(Flags1& a, const Flags1& b) { return a = (Flags1)((std::uint32_t)a ^ (std::uint32_t)b); }
		friend constexpr Flags1 operator^(const Flags1& a, const Flags1& b) { return (Flags1)((std::uint32_t)a ^ (std::uint32_t)b); }
		friend constexpr Flags1& operator|=(Flags1& a, const Flags1& b) { return a = (Flags1)((std::uint32_t)a | (std::uint32_t)b); }
		friend constexpr Flags1 operator|(const Flags1& a, const Flags1& b) { return (Flags1)((std::uint32_t)a | (std::uint32_t)b); }
		friend constexpr Flags1& operator&=(Flags1& a, const Flags1& b) { return a = (Flags1)((std::uint32_t)a & (std::uint32_t)b); }
		friend constexpr Flags1 operator&(const Flags1& a, const Flags1& b) { return (Flags1)((std::uint32_t)a & (std::uint32_t)b); }
		friend constexpr Flags1 operator~(const Flags1& a) { return (Flags1)(~((std::uint32_t)a)); }
		friend constexpr std::uint32_t operator+(const Flags1& a, const Flags1& b) { return ((std::uint32_t)a + (std::uint32_t)b); }
		friend constexpr std::uint32_t operator+(const Flags1& a, const std::uint32_t& b) { return ((std::uint32_t)a + b); }
		friend constexpr std::uint32_t operator+(const std::uint32_t& a, const Flags1& b) { return (a + (std::uint32_t)b); }
		friend constexpr std::uint32_t operator-(const Flags1& a, const Flags1& b) { return ((std::uint32_t)a - (std::uint32_t)b); }
		friend constexpr std::uint32_t operator-(const Flags1& a, const std::uint32_t& b) { return ((std::uint32_t)a - b); }
		friend constexpr std::uint32_t operator-(const std::uint32_t& a, const Flags1& b) { return (a - (std::uint32_t)b); }
		friend constexpr Flags1 operator++(Flags1& a, int) { auto temp = a; a = Flags1(a + 1); return temp; }
		friend constexpr Flags1& operator++(Flags1& a) { return a = Flags1(a + 1); }
		friend constexpr Flags1 operator--(Flags1& a, int) { auto temp = a; a = Flags1(a - 1); return temp; }
		friend constexpr Flags1& operator--(Flags1& a) { return a = Flags1(a - 1); }
		friend constexpr bool operator==(const Flags1& a, const std::uint32_t& b) { return ((std::uint32_t)a == b); }
		friend constexpr bool operator==(const std::uint32_t& a, const Flags1& b) { return (a == (std::uint32_t)b); }
		friend constexpr bool operator>=(const Flags1& a, const std::uint32_t& b) { return ((std::uint32_t)a >= b); }
		friend constexpr bool operator>=(const std::uint32_t& a, const Flags1& b) { return (a >= (std::uint32_t)b); }
		friend constexpr bool operator<=(const Flags1& a, const std::uint32_t& b) { return ((std::uint32_t)a <= b); }
		friend constexpr bool operator<=(const std::uint32_t& a, const Flags1& b) { return (a <= (std::uint32_t)b); }
	...
	private:
		...
		friend constexpr Flags2& operator^=(Flags2& a, const Flags2& b) { return a = (Flags2)((std::uint32_t)a ^ (std::uint32_t)b); }
		friend constexpr Flags2 operator^(const Flags2& a, const Flags2& b) { return (Flags2)((std::uint32_t)a ^ (std::uint32_t)b); }
		friend constexpr Flags2& operator|=(Flags2& a, const Flags2& b) { return a = (Flags2)((std::uint32_t)a | (std::uint32_t)b); }
		friend constexpr Flags2 operator|(const Flags2& a, const Flags2& b) { return (Flags2)((std::uint32_t)a | (std::uint32_t)b); }
		friend constexpr Flags2& operator&=(Flags2& a, const Flags2& b) { return a = (Flags2)((std::uint32_t)a & (std::uint32_t)b); }
		friend constexpr Flags2 operator&(const Flags2& a, const Flags2& b) { return (Flags2)((std::uint32_t)a & (std::uint32_t)b); }
		friend constexpr Flags2 operator~(const Flags2& a) { return (Flags2)(~((std::uint32_t)a)); }
		friend constexpr std::uint32_t operator+(const Flags2& a, const Flags2& b) { return ((std::uint32_t)a + (std::uint32_t)b); }
		friend constexpr std::uint32_t operator+(const Flags2& a, const std::uint32_t& b) { return ((std::uint32_t)a + b); }
		friend constexpr std::uint32_t operator+(const std::uint32_t& a, const Flags2& b) { return (a + (std::uint32_t)b); }
		friend constexpr std::uint32_t operator-(const Flags2& a, const Flags2& b) { return ((std::uint32_t)a - (std::uint32_t)b); }
		friend constexpr std::uint32_t operator-(const Flags2& a, const std::uint32_t& b) { return ((std::uint32_t)a - b); }
		friend constexpr std::uint32_t operator-(const std::uint32_t& a, const Flags2& b) { return (a - (std::uint32_t)b); }
		friend constexpr Flags2 operator++(Flags2& a, int) { auto temp = a; a = Flags2(a + 1); return temp; }
		friend constexpr Flags2& operator++(Flags2& a) { return a = Flags2(a + 1); }
		friend constexpr Flags2 operator--(Flags2& a, int) { auto temp = a; a = Flags2(a - 1); return temp; }
		friend constexpr Flags2& operator--(Flags2& a) { return a = Flags2(a - 1); }
		friend constexpr bool operator==(const Flags2& a, const std::uint32_t& b) { return ((std::uint32_t)a == b); }
		friend constexpr bool operator==(const std::uint32_t& a, const Flags2& b) { return (a == (std::uint32_t)b); }
		friend constexpr bool operator>=(const Flags2& a, const std::uint32_t& b) { return ((std::uint32_t)a >= b); }
		friend constexpr bool operator>=(const std::uint32_t& a, const Flags2& b) { return (a >= (std::uint32_t)b); }
		friend constexpr bool operator<=(const Flags2& a, const std::uint32_t& b) { return ((std::uint32_t)a <= b); }
		friend constexpr bool operator<=(const std::uint32_t& a, const Flags2& b) { return (a <= (std::uint32_t)b); }
