...
namespace Iced::Intel
{
	...
	/// </summary>
	class RegisterExtensions final
	{
	public:
		static std::vector<RegisterInfo> RegisterInfos;
	private:
		static std::vector<RegisterInfo> GetRegisterInfos();
		/// <summary>
		/// Gets register info
		/// </summary>
	...
	public:
		...
		/// <param name="register">Register</param>
		/// <returns></returns>
		static Register GetFullRegister32(Register register_);
		/// <summary>
		/// Gets the size of the register in bytes
		/// </summary>
		/// <param name="register">Register</param>
		/// <returns></returns>
		static std::int32_t GetSize(Register register_);
