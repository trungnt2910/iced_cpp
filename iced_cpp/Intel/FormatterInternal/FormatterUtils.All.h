...
public:
static constexpr bool IsNotrackPrefixBranch(Code code)
{
...
static constexpr bool ShowSegmentPrefix(Register defaultSegReg, const Instruction& instruction, bool showUselessPrefixes)
{
...
static constexpr bool ShowRepOrRepePrefix(Code code, bool showUselessPrefixes)
{
...
static constexpr bool ShowRepnePrefix(Code code, bool showUselessPrefixes)
{
...
static constexpr bool IsRepeOrRepneInstruction(Code code)
{
	switch (code)
	{
...
private:
static constexpr bool IsCode64(CodeSize codeSize)
{
	return codeSize == CodeSize::Code64 || codeSize == CodeSize::Unknown;
}

static constexpr Iced::Intel::Register GetDefaultSegmentRegister(const Instruction& instruction)
{
...
static constexpr bool IsRepRepeRepneInstruction(Code code)
{
	switch (code)
	{
