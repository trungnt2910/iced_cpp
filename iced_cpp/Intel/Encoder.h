...
namespace Iced::Intel
{
	...
	private:
		...
		/* readonly */
		::Iced::Intel::EncoderInternal::EncoderFlags opSize16Flags = static_cast<::Iced::Intel::EncoderInternal::EncoderFlags>(0);
		/* readonly */
		::Iced::Intel::EncoderInternal::EncoderFlags opSize32Flags = static_cast<::Iced::Intel::EncoderInternal::EncoderFlags>(0);
		/* readonly */
		::Iced::Intel::EncoderInternal::EncoderFlags adrSize16Flags = static_cast<::Iced::Intel::EncoderInternal::EncoderFlags>(0);
		/* readonly */
		::Iced::Intel::EncoderInternal::EncoderFlags adrSize32Flags = static_cast<::Iced::Intel::EncoderInternal::EncoderFlags>(0);
	public:
		std::uint32_t OpCode = 0;
		::Iced::Intel::EncoderInternal::EncoderFlags EncoderFlags = static_cast<::Iced::Intel::EncoderInternal::EncoderFlags>(0);
	private:
		::Iced::Intel::EncoderInternal::DisplSize DisplSize = static_cast<::Iced::Intel::EncoderInternal::DisplSize>(0);
	public:
		::Iced::Intel::EncoderInternal::ImmSize ImmSize = static_cast<::Iced::Intel::EncoderInternal::ImmSize>(0);
	private:
		std::uint8_t ModRM = 0;
		std::uint8_t Sib = 0;
		/// <summary>
