...
#include "MasmFormatterInternal/InstrInfo.h"
...
#include "MasmFormatterInternal/InstrOpInfoFlags.g.h"
...
namespace Iced::Intel
{
	...
	public:
	  ...
	  //ORIGINAL LINE: public MasmFormatter(ISymbolResolver? symbolResolver, System.Nullable<IFormatterOptionsProvider> optionsProvider = null) : this(null, symbolResolver, optionsProvider)
		MasmFormatter(ISymbolResolver* symbolResolver, IFormatterOptionsProvider* optionsProvider = nullptr);
		/// <summary>
		/// Constructor
		/// </summary>
	  ...
	  //ORIGINAL LINE: public MasmFormatter(FormatterOptions? options, System.Nullable<ISymbolResolver> symbolResolver = null, System.Nullable<IFormatterOptionsProvider> optionsProvider = null)
		MasmFormatter(const FormatterOptions& options, ISymbolResolver* symbolResolver = nullptr, IFormatterOptionsProvider* optionsProvider = nullptr);
	private:
		static FormatterString str_bnd;
		static FormatterString str_far;
		static FormatterString str_hnt;
		static FormatterString str_ht;
		static FormatterString str_lock;
		static FormatterString str_near;
		static FormatterString str_notrack;
		static FormatterString str_offset;
		static FormatterString str_ptr;
		...
		static FormatterString str_short;
	...
	private:
		...
		void FormatMemory(FormatterOutput& output, const Instruction& instruction, std::int32_t operand, std::int32_t instructionOperand, Register segReg, Register baseReg, Register indexReg, std::int32_t scale, std::int32_t displSize, std::int64_t displ, std::int32_t addrSize, InstrOpInfoFlags flags);
		...
		void FormatMemorySize(FormatterOutput& output, const Instruction& instruction, SymbolResult& symbol, MemorySize memSize, InstrOpInfoFlags flags, FormatterOperandOptions operandOptions, bool useSymbol);
