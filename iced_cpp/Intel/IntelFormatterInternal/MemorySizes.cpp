...
namespace Iced::Intel::IntelFormatterInternal
{
	...
	MemorySizes::Info::Info(std::vector<FormatterString>& keywords, FormatterString bcstTo)
	{
		this->keywords = keywords;
		this->bcstTo = bcstTo;
	}

	std::vector<Info> MemorySizes::AllMemorySizes = GetMemorySizes();

	std::vector<Info> MemorySizes::GetMemorySizes()
	{
	 ...
	 //ORIGINAL LINE: var keywords = (switchTempVar_0 == 0x00) ? Array2.Empty<FormatterString>() : (switchTempVar_0 == 0x01) ? byte_ptr : (switchTempVar_0 == 0x02) ? dword_ptr : (switchTempVar_0 == 0x03) ? fpuenv14_ptr : (switchTempVar_0 == 0x04) ? fpuenv28_ptr : (switchTempVar_0 == 0x05) ? fpustate108_ptr : (switchTempVar_0 == 0x06) ? fpustate94_ptr : (switchTempVar_0 == 0x07) ? fword_ptr : (switchTempVar_0 == 0x08) ? qword_ptr : (switchTempVar_0 == 0x09) ? tbyte_ptr : (switchTempVar_0 == 0x0A) ? word_ptr : (switchTempVar_0 == 0x0B) ? xmmword_ptr : (switchTempVar_0 == 0x0C) ? ymmword_ptr : (switchTempVar_0 == 0x0D) ? zmmword_ptr : (switchTempVar_0 == 0x0E) ? mem384_ptr : throw new InvalidOperationException();
			auto keywords = (switchTempVar_0 == 0x00) ? Array2::Empty<FormatterString>() : (switchTempVar_0 == 0x01) ? byte_ptr : (switchTempVar_0 == 0x02) ? dword_ptr : (switchTempVar_0 == 0x03) ? fpuenv14_ptr : (switchTempVar_0 == 0x04) ? fpuenv28_ptr : (switchTempVar_0 == 0x05) ? fpustate108_ptr : (switchTempVar_0 == 0x06) ? fpustate94_ptr : (switchTempVar_0 == 0x07) ? fword_ptr : (switchTempVar_0 == 0x08) ? qword_ptr : (switchTempVar_0 == 0x09) ? tbyte_ptr : (switchTempVar_0 == 0x0A) ? word_ptr : (switchTempVar_0 == 0x0B) ? xmmword_ptr : (switchTempVar_0 == 0x0C) ? ymmword_ptr : (switchTempVar_0 == 0x0D) ? zmmword_ptr : (switchTempVar_0 == 0x0E) ? mem384_ptr : throw InvalidOperationException();
	 ...
	 //ORIGINAL LINE: var bcstTo = (switchTempVar_1 == 0x00) ? empty : (switchTempVar_1 == 0x01) ? b1to2 : (switchTempVar_1 == 0x02) ? b1to4 : (switchTempVar_1 == 0x03) ? b1to8 : (switchTempVar_1 == 0x04) ? b1to16 : (switchTempVar_1 == 0x05) ? b1to32 : throw new InvalidOperationException();
			auto bcstTo = (switchTempVar_1 == 0x00) ? empty : (switchTempVar_1 == 0x01) ? b1to2 : (switchTempVar_1 == 0x02) ? b1to4 : (switchTempVar_1 == 0x03) ? b1to8 : (switchTempVar_1 == 0x04) ? b1to16 : (switchTempVar_1 == 0x05) ? b1to32 : throw InvalidOperationException();
