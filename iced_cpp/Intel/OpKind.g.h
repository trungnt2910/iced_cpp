...
namespace Iced::Intel {
	...
	constexpr int operator+(const OpKind& a, const OpKind& b) { return ((int)a + (int)b); }
	constexpr int operator+(const OpKind& a, const int& b) { return ((int)a + b); }
	constexpr int operator+(const int& a, const OpKind& b) { return (a + (int)b); }
	constexpr int operator-(const OpKind& a, const OpKind& b) { return ((int)a - (int)b); }
	constexpr int operator-(const OpKind& a, const int& b) { return ((int)a - b); }
	constexpr int operator-(const int& a, const OpKind& b) { return (a - (int)b); }
	constexpr OpKind operator++(OpKind& a, int) { auto temp = a; a = OpKind(a + 1); return temp; }
	constexpr OpKind& operator++(OpKind& a) { return a = OpKind(a + 1); }
	constexpr OpKind operator--(OpKind& a, int) { auto temp = a; a = OpKind(a - 1); return temp; }
	constexpr OpKind& operator--(OpKind& a) { return a = OpKind(a - 1); }
	constexpr bool operator==(const OpKind& a, const int& b) { return ((int)a == b); }
	constexpr bool operator==(const int& a, const OpKind& b) { return (a == (int)b); }
	constexpr bool operator>=(const OpKind& a, const int& b) { return ((int)a >= b); }
	constexpr bool operator>=(const int& a, const OpKind& b) { return (a >= (int)b); }
	constexpr bool operator<=(const OpKind& a, const int& b) { return ((int)a <= b); }
	constexpr bool operator<=(const int& a, const OpKind& b) { return (a <= (int)b); }
...
template <>
constexpr std::string Iced::Intel::ToString(const Iced::Intel::OpKind& e) {
	switch (e) {
		case Iced::Intel::OpKind::Register: return "Register";
		case Iced::Intel::OpKind::NearBranch16: return "NearBranch16";
		case Iced::Intel::OpKind::NearBranch32: return "NearBranch32";
		case Iced::Intel::OpKind::NearBranch64: return "NearBranch64";
		case Iced::Intel::OpKind::FarBranch16: return "FarBranch16";
		case Iced::Intel::OpKind::FarBranch32: return "FarBranch32";
		case Iced::Intel::OpKind::Immediate8: return "Immediate8";
		case Iced::Intel::OpKind::Immediate8_2nd: return "Immediate8_2nd";
		case Iced::Intel::OpKind::Immediate16: return "Immediate16";
		case Iced::Intel::OpKind::Immediate32: return "Immediate32";
		case Iced::Intel::OpKind::Immediate64: return "Immediate64";
		case Iced::Intel::OpKind::Immediate8to16: return "Immediate8to16";
		case Iced::Intel::OpKind::Immediate8to32: return "Immediate8to32";
		case Iced::Intel::OpKind::Immediate8to64: return "Immediate8to64";
		case Iced::Intel::OpKind::Immediate32to64: return "Immediate32to64";
		case Iced::Intel::OpKind::MemorySegSI: return "MemorySegSI";
		case Iced::Intel::OpKind::MemorySegESI: return "MemorySegESI";
		case Iced::Intel::OpKind::MemorySegRSI: return "MemorySegRSI";
		case Iced::Intel::OpKind::MemorySegDI: return "MemorySegDI";
		case Iced::Intel::OpKind::MemorySegEDI: return "MemorySegEDI";
		case Iced::Intel::OpKind::MemorySegRDI: return "MemorySegRDI";
		case Iced::Intel::OpKind::MemoryESDI: return "MemoryESDI";
		case Iced::Intel::OpKind::MemoryESEDI: return "MemoryESEDI";
		case Iced::Intel::OpKind::MemoryESRDI: return "MemoryESRDI";
		case Iced::Intel::OpKind::Memory: return "Memory";
