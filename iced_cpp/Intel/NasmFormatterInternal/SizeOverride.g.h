...
template <>
constexpr std::string Iced::Intel::ToString(const Iced::Intel::NasmFormatterInternal::SizeOverride& e) {
	switch (e) {
		case Iced::Intel::NasmFormatterInternal::SizeOverride::None: return "None";
		case Iced::Intel::NasmFormatterInternal::SizeOverride::Size16: return "Size16";
		case Iced::Intel::NasmFormatterInternal::SizeOverride::Size32: return "Size32";
		case Iced::Intel::NasmFormatterInternal::SizeOverride::Size64: return "Size64";
