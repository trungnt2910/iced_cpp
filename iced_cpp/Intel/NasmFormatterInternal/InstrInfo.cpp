...
namespace Iced::Intel::NasmFormatterInternal
{
	...
	void SimpleInstrInfo_push_imm8::GetOpInfo(FormatterOptions* options, Instruction const instruction, InstrOpInfo& info)
	{
	...
	void SimpleInstrInfo_push_imm::GetOpInfo(FormatterOptions* options, Instruction const instruction, InstrOpInfo& info)
	{
	...
	void SimpleInstrInfo_SignExt::GetOpInfo(FormatterOptions* options, Instruction const instruction, InstrOpInfo& info)
	{
	...
	void SimpleInstrInfo_String::GetOpInfo(FormatterOptions* options, Instruction const instruction, InstrOpInfo& info)
	{
	...
	SimpleInstrInfo_STIG2::SimpleInstrInfo_STIG2(const std::string& mnemonic, bool pseudoOp) : SimpleInstrInfo_STIG2(mnemonic, 0, pseudoOp)
	{
	}
	...
	void SimpleInstrInfo_STIG2::GetOpInfo(FormatterOptions* options, Instruction const instruction, InstrOpInfo& info)
	{
		info = Iced::Intel::GasFormatterInternal::InstrOpInfo();
		info.Flags = flags;
		info.Mnemonic = mnemonic;
	...
	void SimpleInstrInfo_reverse::GetOpInfo(FormatterOptions* options, Instruction const instruction, InstrOpInfo& info)
	{
		...
		info.MemorySize = instruction.GetMemorySize();
	}
	...
	void SimpleInstrInfo_os_mem_reg16::GetOpInfo(FormatterOptions* options, Instruction const instruction, InstrOpInfo& info)
	{
		auto flags = InstrOpInfoFlags::None;
		std::int32_t instrBitness = GetBitness(instruction.GetCodeSize());
	...
	void SimpleInstrInfo_os_call::GetOpInfo(FormatterOptions* options, Instruction const instruction, InstrOpInfo& info)
	{
		auto flags = InstrOpInfoFlags::None;
	...
	void SimpleInstrInfo_far_mem::GetOpInfo(FormatterOptions* options, Instruction const instruction, InstrOpInfo& info)
	{
