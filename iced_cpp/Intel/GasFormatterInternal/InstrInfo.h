...
namespace Iced::Intel::GasFormatterInternal
{
	...
	public:
		SimpleInstrInfo_cc(std::int32_t ccIndex, std::vector<std::string>& mnemonics, std::vector<std::string>& mnemonics_suffix);
		void GetOpInfo(FormatterOptions* options, Instruction const instruction, InstrOpInfo& info) override;
	};
	...
	private:
		...
		std::vector<FormatterString> mnemonics_suffix;
	public:
		SimpleInstrInfo_os_loop(std::int32_t bitness, std::int32_t regSize, std::int32_t ccIndex, std::vector<std::string>& mnemonics, std::vector<std::string>& mnemonics_suffix);
		void GetOpInfo(FormatterOptions* options, Instruction const instruction, InstrOpInfo& info) override;
	};
	...
	public:
		SimpleInstrInfo_pops(const std::string& mnemonic, std::vector<FormatterString>& pseudo_ops, bool canUseSae);
		void GetOpInfo(FormatterOptions* options, Instruction const instruction, InstrOpInfo& info) override;
