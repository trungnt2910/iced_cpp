...
namespace Iced::Intel::GasFormatterInternal
{
	...
	protected:
		...
		static FormatterString GetMnemonic(const FormatterOptions& options, const Instruction& instruction, FormatterString mnemonic, FormatterString mnemonic_suffix, InstrOpInfoFlags flags);
	};
