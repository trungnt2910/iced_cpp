...
template <>
constexpr std::string Iced::Intel::ToString(const Iced::Intel::GasFormatterInternal::SizeOverride& e) {
	switch (e) {
		case Iced::Intel::GasFormatterInternal::SizeOverride::None: return "None";
		case Iced::Intel::GasFormatterInternal::SizeOverride::Size16: return "Size16";
		case Iced::Intel::GasFormatterInternal::SizeOverride::Size32: return "Size32";
		case Iced::Intel::GasFormatterInternal::SizeOverride::Size64: return "Size64";
